export default (link: string, email: string, hours: number) => {
  ...
  <html>
    ...
    <body bgcolor="#ffffff" style="background-color: #ffffff; margin: 0 !important; padding: 0 !important;">
      <div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;"> - to finish signing up, you just need to confirm that we got your e-mail right within ${hours} hours. To confirm please click the VERIFY button.</div>
      <center>
                          ...
                          <tbody>
                            <tr>
                              <td bgcolor="#ffffff" align="left" style="padding: 20px 0 0 0; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                  <p class="headingMobile" style="margin: 0;color: #171717;font-size: 26px;font-weight: 200;line-height: 130%;margin-bottom:5px;">Verify your e-mail to finish signing up for GraphQL Forum</p>
                              </td>
                            </tr>
                                              <tr>
                                                <td height="20"></td>
                            ...
                            <tr>
                              <td bgcolor="#ffffff" align="left" style="padding:0; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                  ...
                                                  <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Please confirm that <b>${email}</b> is your e-mail address by clicking on the button below or using this link <a style='color: #00bc87;text-decoration: underline;' target='_blank' href='${link}'>${link}</a> within ${hours}&nbsp;hours.</p>
                              </td>
                            </tr>
                                              <tr>
                                                <td align="center">
  ...
  <![endif]-->
    ...
    `Please confirm that ${email} is you email by going to ${link}`,
  ];
};
